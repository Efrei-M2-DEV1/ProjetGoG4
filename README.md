...
```bash
git clone https://github.com/Efrei-M2-DEV1/ProjetGoG4.git
cd ProjetGoG4 # Naviguez vers le dossier du projet cloné
```
...
- 1 point si votre code compile (OK)
- 1 point si vous faites des erreurs personnalisées (OK)
